...
这里我们用到了react-redux hook，是我们可以像使用react hook useReducer那样分发
...
![image-20231012112856257](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310121128674.png)
...
![image-20231012153257076](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310121532191.png)

![image-20231012153322222](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310121533295.png)

middleware

![image-20231012162052094](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310121620913.png)

![image-20231012162113598](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310121621820.png)

![image-20231012162129340](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310121621398.png)

我们可以看到只有selector 被调用，category才有数据
...
我们可以看到。这里reduce，后面的参数是一个{}，尽管控制她接过没变但是他还是render很多次

![image-20231012162548791](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310121625914.png)
...
当我们退出登陆时，只有selector 1 render

![image-20231012171443932](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310121714327.png)

<video src="D:\Video\Captures\React App - Google Chrome 2023-10-12 17-17-16.mp4"></video>

```
npm i redux-persist
```

允许我们将数据保存在localstorge
...
这样我们再次刷新浏览器，数据就不会丢失了

localstorge也会有数据

![image-20231013132139395](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310131321610.png)

<video src="D:\Video\Captures\React App - Google Chrome 2023-10-13 13-22-37.mp4"></video>
...
![image-20231013134247311](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310131342466.png)
...
![image-20231014153747614](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310141537143.png)
...
* generator function
  ...
  undefined
  ge
  gen {<suspended>}[[GeneratorLocation]]: VM1053:1[[Prototype]]: Generator[[GeneratorState]]: "suspended"[[GeneratorFunction]]: ƒ* gen(i)[[GeneratorReceiver]]: Window[[Scopes]]: Scopes[3]
  ge.next()
  {value: 5, done: false}
  ge.next()
  {value: 10, done: false}
  ...
  ![image-20231015132334991](https://makeforpicgo.oss-cn-chengdu.aliyuncs.com/study/202310151323194.png)
